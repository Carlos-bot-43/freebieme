...
function tagDeal(deal) {
  ...
  // Priority 1: Free item keyword parsing (most specific — tells us exactly what the deal is)
  // e.g. "Free Medium Fries" from McDonald's → ['fries'], NOT ['burgers', 'fries']
  ...
  // Priority 2: Chain + deal_type override (authoritative when free_item is absent/generic)
  // e.g. DQ "Birthday Reward" has no item keyword → chain override → ['ice-cream', 'dessert']
