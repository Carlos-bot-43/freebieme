...
const CHAIN_REWARDS_URLS = {
  ...
  'five-guys': 'https://www.fiveguys.com/fans/loyalty-program',
  'tim-hortons': 'https://www.timhortons.com/tims-rewards',
...
const CHAIN_DEAL_TEMPLATES = {
  ...
  'chipotle': [
    {
      ...
      description: 'Chipotle Rewards members get a free entrée during their birthday month. Join Chipotle Rewards via the app.',
  ...
  'starbucks': [
    {
      deal_type: 'birthday',
      title: 'Free drink or food item on your birthday',
      description: 'Starbucks Rewards members get a free handcrafted drink or food item of any size on their birthday. Requires active Starbucks Rewards account.',
      free_item: 'Any size drink or food',
      requires_app: true, requires_signup: true, requires_purchase: false,
  ...
  'subway': [
    {
      deal_type: 'birthday',
      title: 'Free 6-inch sub on your birthday',
      description: 'Subway MVP Rewards members get a free 6-inch sub during their birthday month. Requires Subway MVP Rewards account.',
      free_item: '6-inch sub',
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.8,
    },
    {
  ...
  'panera': [
    {
      ...
      description: 'Join MyPanera Rewards and get a free pastry during your birthday month. Requires MyPanera account.',
    ...
    {
      deal_type: 'app_deal',
      title: 'Unlimited Sip Club — coffee, tea & lemonade',
      description: 'Panera Unlimited Sip Club subscription: pay once per month and get unlimited self-serve drinks every visit (coffee, tea, lemonade, and more). Priced around $14.99/month — each drink after your first visit costs $0.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.9,
    },
    {
      deal_type: 'signup_bonus',
      title: 'Free bakery treat for new members',
      description: 'New MyPanera members receive a free bakery treat with their first purchase. Available via the app or online account.',
      free_item: 'Bakery treat',
  ...
  'wingstop': [
    {
      deal_type: 'birthday',
      title: 'Free 6 wings on your birthday',
      description: 'Wingstop Rewards members get 6 free classic wings during their birthday month. Join The Wing rewards program via the app.',
      free_item: '6 wings',
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.85,
    },
  ...
  // --- Chains added 2026-02-20: templates for chains previously missing from inject ---
  'jack-in-the-box': [
    {
      deal_type: 'birthday',
      title: 'Free birthday reward with Jack Pack',
      description: 'Jack Pack members receive a birthday reward during their birthday month. Download the Jack in the Box app and join Jack Pack to claim.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
    ...
    {
      deal_type: 'app_deal',
      title: 'Exclusive app deals — 2 tacos for $1 and more',
      description: 'Get daily exclusive deals through the Jack in the Box app, including 2 tacos for $1 and other app-only offers.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.85,
    },
  ...
  'del-taco': [
    {
      deal_type: 'birthday',
      title: 'Birthday reward with Del Yeah! Rewards',
      description: 'Del Yeah! Rewards members get a birthday treat during their birthday month. Join via the Del Taco app to claim.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.7,
    },
    {
      deal_type: 'app_deal',
      title: 'App exclusive deals — tacos, burritos & more',
      description: 'Get exclusive app-only offers and weekly deals through the Del Taco app. New deals every week for Del Yeah! Rewards members.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.8,
    },
  ...
  'shake-shack': [
    {
      deal_type: 'birthday',
      title: 'Birthday reward with Shack Track',
      description: 'Shack Track Rewards members receive a birthday reward during their birthday month. Requires the Shake Shack app.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.7,
    },
    {
      deal_type: 'app_deal',
      title: 'Bonus points & app-exclusive deals',
      description: 'Order through the Shake Shack app for bonus point events, exclusive offers, and early access to new menu items.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.8,
    },
  ...
  'ihop': [
    {
      deal_type: 'app_deal',
      title: 'Exclusive app deals & PanCoin bonuses',
      description: 'IHOP International Bank of Pancakes members get exclusive app-only deals and double PanCoin earning on select days.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.8,
    },
  ...
  'dennys': [
    {
      deal_type: 'app_deal',
      title: 'Booth Rewards — earn BoothBucks on every visit',
      description: "Denny's Booth Rewards app: earn 10 BoothBucks per $1 spent. Redeem for free menu items when you hit 600 BoothBucks. Exclusive member deals sent weekly.",
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: true,
      confidence_score: 0.85,
    },
  ...
  'olive-garden': [
    {
      deal_type: 'rewards_program',
      title: 'eClub exclusive member deals',
      description: "Join Olive Garden's eClub for exclusive member-only deals, birthday rewards, and seasonal promotions delivered by email.",
      free_item: null,
      requires_app: false, requires_signup: true, requires_purchase: false,
      confidence_score: 0.8,
    },
  ...
  'red-lobster': [
    {
      deal_type: 'app_deal',
      title: 'Fresh Catch Club app exclusive deals',
      description: 'Fresh Catch Club members get app-exclusive deals and bonus rewards on every visit. Download the Red Lobster app to join.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
    ...
    {
      deal_type: 'signup_bonus',
      title: 'Welcome offer for new Fresh Catch Club members',
      description: 'New Fresh Catch Club members receive a welcome offer on their next visit. Sign up via the Red Lobster app or website.',
      free_item: null,
      requires_app: false, requires_signup: true, requires_purchase: false,
  ...
  'cold-stone-creamery': [
    {
      deal_type: 'signup_bonus',
      title: 'Welcome offer for new My Cold Stone Club members',
      description: 'New My Cold Stone Club members receive a welcome reward on their first visit. Sign up via the app or website.',
      free_item: null,
      requires_app: false, requires_signup: true, requires_purchase: false,
  ...
  'jersey-mikes': [
    {
      deal_type: 'signup_bonus',
      title: 'Free regular sub when you join',
      description: "Join Jersey Mike's Rewards and get a free regular sub on your next visit. Download the app or sign up online.",
      free_item: 'Regular sub',
      requires_app: false, requires_signup: true, requires_purchase: false,
      confidence_score: 0.75,
    },
    {
      deal_type: 'app_deal',
      title: 'App exclusive deals & double point events',
      description: "Order through the Jersey Mike's app for exclusive deals, double point events, and early access to promotions.",
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.8,
    },
    {
      deal_type: 'rewards_program',
      title: "Mike's Way Rewards — earn points per dollar",
      description: "Earn points on every order with Mike's Way Rewards. Points add up to free subs and menu items.",
      free_item: null,
      requires_app: false, requires_signup: true, requires_purchase: true,
      confidence_score: 0.85,
    },
  ...
  'whataburger': [
    {
      deal_type: 'birthday',
      title: 'Birthday reward with Whataburger Rewards',
      description: 'Whataburger Rewards members receive a birthday treat during their birthday month. Download the Whataburger app and join to claim.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.75,
    },
  ...
  'papa-johns': [
    {
      deal_type: 'app_deal',
      title: 'Papa Dough & exclusive app deals',
      description: "Order through the Papa John's app for exclusive deals, Papa Dough rewards, and bonus offers. Papa Rewards members earn Papa Dough on every order.",
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.8,
    },
  ],
  // --- Chains added 2026-03-26: Five Guys, Tim Hortons, Krispy Kreme ---
  'five-guys': [
    {
      deal_type: 'birthday',
      title: 'Free Little Bacon Cheeseburger on your birthday',
      description: 'Five Guys Loyalty members get a free Little Bacon Cheeseburger on their birthday. Sign up via the Five Guys app or website to activate your reward.',
      free_item: 'Little Bacon Cheeseburger',
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.8,
    },
    {
      deal_type: 'signup_bonus',
      title: 'Free small fries when you join',
      description: 'Join the Five Guys loyalty program and earn points toward free food. New members often receive a welcome offer on their first order.',
      free_item: 'Small fries',
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.75,
    },
    {
      deal_type: 'rewards_program',
      title: 'Five Guys rewards — earn free burgers',
      description: 'Every purchase earns Five Guys loyalty points. Redeem points for free burgers, fries, and drinks. No purchase minimum to start earning.',
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.85,
    },
  ...
  'tim-hortons': [
    {
      deal_type: 'birthday',
      title: 'Free birthday treat with Tims Rewards',
      description: 'Tims Rewards members receive a free baked good or beverage during their birthday week. Download the Tim Hortons app and register to unlock your birthday reward.',
      free_item: 'Free baked good or beverage',
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.85,
    },
    {
      deal_type: 'signup_bonus',
      title: 'Free medium hot beverage when you join',
      description: 'Sign up for Tims Rewards and get a free medium hot beverage on your first visit. Earn 10 points per $1 spent — redeem for free coffees, food, and more.',
      free_item: 'Medium hot beverage',
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.85,
    },
    {
      deal_type: 'app_deal',
      title: 'Roll Up to Win & Tims Rewards bonus events',
      description: "Tim Hortons runs regular bonus-point events and the annual Roll Up to Win promotion exclusively through the app. Stack points faster with app orders.",
      free_item: null,
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.9,
    },
  ...
  'krispy-kreme': [
    {
      deal_type: 'birthday',
      title: 'Free dozen original glazed on your birthday',
      description: "Krispy Kreme Rewards members get a free dozen Original Glazed doughnuts on their birthday. Create a free account and verify your birthday to redeem.",
      free_item: 'Dozen Original Glazed doughnuts',
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.9,
    },
    {
      deal_type: 'signup_bonus',
      title: 'Free doughnut when you join rewards',
      description: 'Join Krispy Kreme Rewards and get a free doughnut of your choice on your first visit. No purchase required to redeem your welcome treat.',
      free_item: 'Free doughnut',
      requires_app: false, requires_signup: true, requires_purchase: false,
      confidence_score: 0.9,
    },
    {
      deal_type: 'app_deal',
      title: 'Friday free doughnut — Krispy Kreme Hot Light',
      description: "When the Hot Light is on, Krispy Kreme frequently offers free original glazed doughnuts. App members also get exclusive deals and early access to new flavors.",
      free_item: 'Original Glazed doughnut',
      requires_app: true, requires_signup: true, requires_purchase: false,
      confidence_score: 0.8,
    },
  ],
  ...
  for (const [chainSlug, templates] of Object.entries(CHAIN_DEAL_TEMPLATES)) {
    ...
    for (const template of templates) {
      ...
      for (const loc of locations) {
        ...
        newDeal.value_summary = getValueSummary(newDeal);
